# -*- coding: utf-8 -*-
"""NLP-Tokenização.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1L9MlCeEiZr7QVU6uK6soFaQUi6scUYvD
"""
...
doc = nlp("I'm learning NLP, this course is amazing")

for token in doc:
  print(token)

doc = "I'm learning NLP, this course is amazing"
doc1.split(' ')